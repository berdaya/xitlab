...
const socials = [
	...
	{
		icon: <Linkedin size={20} />,
		href: "https://www.linkedin.com/in/fanny-bagus-ramadhan/",
		label: "Full-Stack Engineer",
		handle: "Fanny Bagus",
		photo: ASSETS.question.src,
	},	
...
export default function TeamsPage() {
	return (
		<div className=" bg-gradient-to-tl from-zinc-900/0 via-zinc-900 to-zinc-900/0 md:py-20">
			<Navigation />
